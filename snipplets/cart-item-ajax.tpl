      ...
      <div class="col {% if cart_page %}col-md-5 pr-0 pr-md-3{% endif %}">
        ...
        <div class="font-small mb-1 {% if cart_page %}font-md-body{% endif %}" data-component="line-item.name">
          ...
          {% if item.is_kit and item.kit_components is not empty %}
            ...
            <a href="#" data-toggle="#{{ kit_modal_id }}" class="js-modal-open js-open-over-modal btn-link font-small d-block mt-1" data-component="line-item.kit-breakdown-link">
              {{ "Ver contenido" | translate }}
            </a>
            {% embed "snipplets/modal.tpl" with{
                item: item, modal_id: kit_modal_id, modal_class: 'bottom modal-centered-small',
                modal_position: 'center', modal_transition: 'slide', modal_header_title: true,
                modal_width: 'centered', modal_zindex_top: true} only %}
              {% block modal_head %}{{ item.short_name }}{% endblock %}
              {% block modal_body %}
                {{ component('cart-kit-components', {
                    ...
                    classes: {
                      ...
                      item: 'my-3 d-flex align-items-center',
